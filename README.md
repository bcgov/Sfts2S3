# sfts2s3
Utility to move all files from BC Secure File Transfer Service to s3, once or cron. 
...
```
oc new-app https://github.com/bcgov/sfts2s3.git --strategy=source <-e ENV=VALUE> ...
```
